...
fun SettingsScreen(
    ...
    val icalTokenRotatedMsg = stringResource(Res.string.ical_token_rotated)
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_account)) {
                    SettingsClickableItem(
                        title = stringResource(Res.string.account_logged_in_as),
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_timetable)) {
                    SettingsClickableItem(
                        title = stringResource(Res.string.pref_default_view),
                        subtitle = stringResource(
                            if (userSettings.defaultViewMode == TimetableViewMode.WEEKLY) Res.string.pref_view_grid
                            else Res.string.pref_view_list
                        ),
                    ...
                    SettingsSwitchItem(
                        title = stringResource(Res.string.pref_merge_lessons),
                        description = stringResource(Res.string.pref_merge_lessons_desc),
                    ...
                    HorizontalDivider(color = MaterialTheme.colorScheme.outlineVariant.copy(alpha = 0.3f))
                    SettingsSwitchItem(
                        title = stringResource(Res.string.pref_weekend_advance),
                        description = stringResource(Res.string.pref_weekend_advance_desc),
                    ...
                    HorizontalDivider(color = MaterialTheme.colorScheme.outlineVariant.copy(alpha = 0.3f))
                    SettingsSwitchItem(
                        title = stringResource(Res.string.pref_scale_breaks),
                        description = stringResource(Res.string.pref_scale_breaks_desc),
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_calendar)) {
                    SettingsClickableItem(
                        title = stringResource(Res.string.pref_ical_feed),
                        subtitle = stringResource(Res.string.pref_ical_feed_desc),
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_appearance)) {
                    ...
                    HorizontalDivider(color = MaterialTheme.colorScheme.outlineVariant.copy(alpha = 0.3f))
                    SettingsSwitchItem(
                        title = stringResource(Res.string.pref_dynamic_color),
                        description = stringResource(Res.string.pref_dynamic_color_desc),
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_storage)) {
                    SettingsClickableItem(
                        title = stringResource(Res.string.pref_clear_cache),
                        subtitle = stringResource(Res.string.pref_clear_cache_desc),
                    ...
                    HorizontalDivider(color = MaterialTheme.colorScheme.outlineVariant.copy(alpha = 0.3f))
                    SettingsSwitchItem(
                        title = stringResource(Res.string.pref_preload_weeks),
                        description = stringResource(Res.string.pref_preload_weeks_desc),
            ...
            item {
                SettingsGroupCard(title = stringResource(Res.string.section_about)) {
                    SettingsClickableItem(
                        title = "Xenon",
                        subtitle = stringResource(Res.string.about_version, "1.0.0"),
                    ...
                    HorizontalDivider(color = MaterialTheme.colorScheme.outlineVariant.copy(alpha = 0.3f))
                    SettingsClickableItem(
                        title = stringResource(Res.string.section_debug),
                        subtitle = stringResource(Res.string.debug_subtitle),
